...
%%%/archive/data/ASDD/pipelines/fmri/nback%%%
% Laagis scripts: /scratch/lyoganathan/Scripts/MATLAB_SPM/%%%
%%%This only run subject once at a time and have to load spm12 onto matlab environment %%%

addpath /projects/ttan/ASSD/Code/SPM/SPM_bat_scripts %% Change this to path where you store your script and spm12
spm fmri

%%%spm frmi%%%

%load /mnt/tigrlab/projects/colin/ASDD/activations/sublist.mat
%%% sub list%
%%%subj = 'EF024';%%%
...
basedir = ['/mnt/tigrlab/projects/ttan/ASSD/Data/testing/'];%%%
...
mregress = [mf.CSF mf.WhiteMatter dvars fd mf.GlobalSignal mf.X mf.Y mf.X mf.RotX mf.RotY mf.RotZ];
